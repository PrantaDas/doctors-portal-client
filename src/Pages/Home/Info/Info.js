        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 px-10 mt-10'>
            <div className="card lg:card-side shadow-xl bg-gradient-to-r from-secondary to-primary">
                ...
                <div className="card-body">
                    <h2 className="card-title text-white pl-2">Opening Hours</h2>
            ...
            <div className="card lg:card-side bg-accent shadow-xl">
                ...
                <div className="card-body">
                    <h2 className="card-title pl-14 text-white">Visit our location</h2>
            ...
            <div className="card lg:card-side bg-gradient-to-r from-secondary to-primary shadow-xl">
                ...
                <div className="card-body">
                    <h2 className="card-title pl-20 text-white">Contact us now</h2>
